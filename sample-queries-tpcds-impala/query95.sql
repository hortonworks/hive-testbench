...
LEFT SEMI JOIN (SELECT ws2.ws_order_number as ws_order_number
			       ...
			       and ws2.ws_sold_date_sk between 2452396        and 2452456
			       and ws3.ws_sold_date_sk between 2452396        and 2452456
			) ws_wh1
...
LEFT SEMI JOIN (SELECT wr_order_number
					 ...
					 and ws4.ws_sold_date_sk between 2452396        and 2452456
					 and ws5.ws_sold_date_sk between 2452396        and 2452456
				) ws_wh2
                               ON (wr.wr_order_number = ws_wh2.ws_order_number)) tmp1
ON (ws1.ws_order_number = tmp1.wr_order_number)
WHERE d.d_date_sk between 2452396        and 2452456 and
	       ws_sold_date_sk between 2452396        and 2452456 and
               ca.ca_state = 'GA' and
